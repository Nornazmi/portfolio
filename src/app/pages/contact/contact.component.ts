        ...
        <div>
          ...
          <div class="space-y-4">
            <div class="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
              ...
              <p class="text-zinc-600 dark:text-zinc-400">nornazmi00&#64;gmail.com</p>
            </div>
            <div class="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
              <h3 class="font-medium text-zinc-900 dark:text-white mb-1">LinkedIn</h3>
              <p class="text-zinc-600 dark:text-zinc-400">linkedin.com/in/mohamad-nornazmi</p>
            </div>
            <div class="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
              <h3 class="font-medium text-zinc-900 dark:text-white mb-1">GitHub</h3>
              <p class="text-zinc-600 dark:text-zinc-400">github.com/Nornazmi</p>
            </div>
          </div>
        </div>
            ...
            <div class="space-y-6">
              ...
              <button type="submit" 
                      class="px-6 py-3 rounded-xl bg-accent text-black dark:text-white font-medium text-sm
                             hover:bg-indigo-500 active:scale-95 transition-all shadow-lg
